...
- **Gallery color palette reduced to logo swatches** - `GalleryColorsPage` and the Window page accent picker now present the seven-color Fluence.Wpf logo palette instead of the broader theme brush catalogue / Windows accent strip.
