...
- Demo: the shared page content margin is 45,24,44,48, which puts the sample card's left edge at 365 dp and its width at 791 dp, matching the Gallery. The page header action buttons are 40 by 31, the title bar icon is 16 by 16 and the title bar search box is 320 by 33. The sample demo area takes a minimum height that matches the Gallery's single-control samples.
