...
- **Per-control screenshots** - `docs/screenshots/` contains `banner-{light|dark|highcontrast}-{1|1.5}x.png`, regenerated by `GalleryScreenshotHarness` during full test runs.
